...
public class MaximumProblmeTest
{
   /* Testing Integer Value For Maximum */
    @Test
    public void givenIntegerMaxNumber_WhenAtAnyPoistion_ThenShouldReturnExpectedNumber()
    {
       Integer expected = 50;
    ...
    @Test
    public void givenFloatMaxNumber_WhenAtAnyPoistion_ThenShouldReturnExpectedNumber()
    {
